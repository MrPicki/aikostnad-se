    ...
    <section aria-label="Enkel AI-kostnadsestimering">
      {(status === "idle" || status === "error") && (
        <div className="max-w-2xl mx-auto">
          <label htmlFor="estimate-input" className="block text-lg font-bold mb-2 text-center bg-gradient-to-r from-indigo-500 via-purple-500 to-cyan-500 bg-clip-text text-transparent">

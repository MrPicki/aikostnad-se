        ...
        <article className="prose prose-gray max-w-none">
          ...
          <section className="space-y-3 mb-12 bg-gray-50 border border-gray-200 rounded-xl p-6 not-prose">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              <Link to="/ai-kostnad-per-manad" className="text-indigo-600 hover:underline font-medium">vad AI kostar per månad</Link>{" "}
              och{" "}
              <Link to="/vad-kostar-ai" className="text-indigo-600 hover:underline font-medium">komplett AI-prisguide 2026</Link>{" "}

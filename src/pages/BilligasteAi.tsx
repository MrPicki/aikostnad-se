          ...
          <div className="prose text-gray-600 space-y-4 text-base leading-relaxed">
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>
                ...
                <Link to="/vad-kostar-chatgpt" className="text-brand-700 hover:underline">Detaljerad ChatGPT-prisguide</Link>.
              </li>
              <li>
              ...
              <li>
                ...
                <Link to="/claude-pris" className="text-brand-700 hover:underline">Räkna på Claude i detalj</Link>.
              </li>
            </ul>
            <p>
        ...
        <section className="mt-12 prose prose-gray max-w-none">
          ...
          <ul>
            ...
            <li>
              ...
              byggare — se vår <Link to="/vad-kostar-chatgpt" className="text-brand-700 hover:underline">ChatGPT-prisguide</Link>.
            </li>
            <li>
              ...
              <Link to="/claude-pris" className="text-brand-700 hover:underline">Claude-prisguide</Link>.
            </li>
            <li>
          ...
          <p>
            ...
            <Link to="/chatgpt-vs-claude" className="text-brand-700 hover:underline">vår jämförelse av ChatGPT vs Claude</Link>{" "}

        ...
        <article className="space-y-8">
            ...
            <ul className="text-gray-600 text-sm leading-relaxed space-y-2">
              ...
              <li className="flex items-start gap-2">
                ...
                <span><strong>Av vem:</strong> {author.name} ({author.role}) på{" "}
                  <a href={parentOrganization.url} target="_blank" rel="noopener noreferrer" className="text-brand-700 hover:underline">
          ...
          <section className="card space-y-3">
            ...
            <p className="text-sm text-gray-700 bg-gray-50 rounded-lg px-4 py-3 font-mono leading-relaxed">
              Källa: <a href="https://aikostnad.se" className="text-brand-700 hover:underline">Aikostnad.se</a>
            </p>
          </section>

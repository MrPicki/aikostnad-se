      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-10">
          ...
          <div className="prose text-gray-600 space-y-4 text-base leading-relaxed">
            ...
            <p>
              ...
              <Link to="/chatgpt-vs-claude" className="text-brand-700 hover:underline">ChatGPT vs Claude</Link>{" "}
              eller den kompletta{" "}
              <Link to="/vad-kostar-ai" className="text-brand-700 hover:underline">AI-prisguiden</Link>.
            </p>
          </div>
        </div>
        ...
        <section className="prose prose-gray max-w-none">
          ...
          <p>
            ...
            <Link to="/prompt-caching" className="text-brand-700 hover:underline">djupguide om prompt caching</Link>.
          </p>
          ...
          <div className="not-prose space-y-4 my-6">
            ...
            <div className="bg-brand-50 border border-brand-100 rounded-xl p-4">
              <h3 className="text-base font-bold text-brand-900 mb-2">Medel RAG-system (50 000 queries/mån)</h3>
              <ul className="text-sm space-y-1 text-gray-700 list-disc pl-5">

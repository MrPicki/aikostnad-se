    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-10">
          ...
          <div className="prose text-gray-600 space-y-4 text-base leading-relaxed">
            ...
            <p>
              ...
              istället räkna på <Link to="/vad-kostar-chatgpt" className="text-indigo-600 hover:underline">ChatGPT-API-kostnaden</Link>{" "}
              eller jämföra med <Link to="/billigaste-ai" className="text-indigo-600 hover:underline">billigaste AI-text-modellerna</Link>?
            </p>
          </div>
        </div>
        ...
        <section className="prose prose-gray max-w-none">
          ...
          <p>
            DALL-E 3 ingår i <Link to="/vad-kostar-chatgpt" className="text-indigo-600 hover:underline">ChatGPT Plus (210 kr/mån)</Link>{" "}
